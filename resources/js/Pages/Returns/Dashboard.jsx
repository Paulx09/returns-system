                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-white shadow overflow-hidden sm:rounded-lg border-t-4 border-t-[#fbdb04] border-b-4 border-b-[#05a060] mb-8">
                        <div className="px-4 py-5 sm:px-6 flex justify-between items-center">
                            ...
                            <div className="bg-[#fbdb04] text-[#002E6E] px-4 py-1 rounded-full font-bold text-sm shadow-sm">
                                        ...
                                        <li key={item.order_item_id} className="p-4 sm:px-6">
                                            <div className="flex items-center mb-4">
                                                <input
                                                    ...
                                                    className="h-5 w-5 text-[#05a060] focus:ring-[#05a060] border-gray-300 rounded"
                                                />
